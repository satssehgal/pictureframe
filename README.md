...
Tested on raspberry pi zero, 3, 3B+, 4B and Mac Big Sur. If the images fails to load on your OS i've included the core files and Docerfile for your to build your own image. 
